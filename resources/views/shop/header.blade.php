                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            <td class="product-image">
                                                <a href="product-detail-left-sidebar.html">
                                                    <img src="{{asset('assets/shop/img/product/7.jpg')}}" alt="Product">
                                                </a>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="product-image">
                                                <a href="product-detail-left-sidebar.html">
                                                    <img src="{{asset('assets/shop/img/product/6.jpg')}}" alt="Product">
                                                </a>
                                            </td>
                                            <td>
                                                <div class="product-name">
        ...
        <ul class="menu">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu">
                    <ul>
                        <li class="has-image">
                            <img src="{{asset('assets/shop/img/product/product-category-1.png')}}" alt="Product Category Image">
                            <a href="product-grid-left-sidebar.html" title="Vegetables">Vegetables</a>
                        </li>
                        <li class="has-image">
                            <img src="{{asset('assets/shop/img/product/product-category-2.png')}}" alt="Product Category Image">
                            <a href="product-grid-left-sidebar.html" title="Fruits">Fruits</a>
                        </li>
                        <li class="has-image">
                            <img src="{{asset('assets/shop/img/product/product-category-3.png')}}" alt="Product Category Image">
                            <a href="product-grid-left-sidebar.html" title="Bread">Bread</a>
                        </li>
                        <li class="has-image">
                            <img src="{{asset('assets/shop/img/product/product-category-4.png')}}" alt="Product Category Image">
                            <a href="product-grid-left-sidebar.html" title="Juices">Juices</a>
                        </li>
                        <li class="has-image">
                            <img src="{{asset('assets/shop/img/product/product-category-5.png')}}" alt="Product Category Image">
