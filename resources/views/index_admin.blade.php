            ...
            <div class="col-12">
                <div class="top_menu_carousel owl-carousel" id="top_menu_carousel">
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{asset('layouts_admin/assets/images/menu/granny-menu10.jpg')}}" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{asset('layouts_admin/assets/images/menu/granny-menu11.jpg')}}" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{asset('layouts_admin/assets/images/menu/granny-menu12.jpg')}}" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{asset('layouts_admin/assets/images/menu/granny-menu13.jpg')}}" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{asset('layouts_admin/assets/images/menu/granny-menu14.jpg')}}" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{asset('layouts_admin/assets/images/menu/granny-menu15.jpg')}}" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{asset('layouts_admin/assets/images/menu/granny-menu16.jpg')}}" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{asset('layouts_admin/assets/images/menu/granny-menu5.jpg')}}" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{asset('layouts_admin/assets/images/menu/granny-menu6.jpg')}}" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                            ...
                            <div class="tab-content tab-content-default">
                                ...
                                <div class="tab-pane fade" id="info1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="media">
                                                <img src="{{asset('layouts_admin/assets/images/avatar/1.jpg')}}" width="35" alt="reviewer">
                                        ...
                                        <div class="col-md-12">
                                            <div class="media mt-4">
                                                <img src="{{asset('layouts_admin/assets/images/avatar/2.jpg')}}" width="35" alt="reviewer">
                                                <div class="media-body ml-4">
                                                    <div class="d-flex justify-content-between">
                                                        <strong>Antony Jonus</strong>
                                                        <div class="vertical-card__menu--rating c-pointer">
                ...
                <div class="card top_menu_widget">
                    <div class="card-body">
                        ...
                        <div class="media border-bottom pt-3 pb-3">
                            <img width="50" height="50" alt="#" class="mr-3" src="{{asset('layouts_admin/assets/images/menu/menu1.png')}}">
                        ...
                        <div class="media border-bottom pt-3 pb-3">
                            <img width="50" height="50" alt="#" class="mr-3" src="{{asset('layouts_admin/assets/images/menu/menu2.png')}}">
                            <div class="media-body">
                        ...
                        <div class="media border-bottom pt-3 pb-3">
                            <img width="50" height="50" alt="#" class="mr-3" src="{{asset('layouts_admin/assets/images/menu/menu3.png')}}">
                            <div class="media-body">
                        ...
                        <div class="media border-bottom pt-3 pb-3">
                            <img width="50" height="50" alt="#" class="mr-3" src="{{asset('layouts_admin/assets/images/menu/menu4.png')}}">
                            <div class="media-body">
                        ...
                        <div class="media border-bottom pt-3 pb-3">
                            <img width="50" height="50" alt="#" class="mr-3" src="{{asset('layouts_admin/assets/images/menu/menu5.png')}}">
                            <div class="media-body">
                        ...
                        <div class="media pt-3 pb-3">
                            <img width="50" height="50" alt="#" class="mr-3" src="{{asset('layouts_admin/assets/images/menu/menu6.png')}}">
                            <div class="media-body">
            ...
            <div class="col-lg-4 col-xxl-4">
                <div class="card performence_score">
                    <div class="card-body">
                        ...
                        <div id="activity">
                            <div class="media border-bottom pt-3 pb-3">
                                <img src="{{asset('layouts_admin/assets/images/avatar/1.jpg')}}" alt="avatar" class="mr-3">
                                <div class="media-body">
                            ...
                            <div class="media border-bottom pt-3 pb-3">
                                <img src="{{asset('layouts_admin/assets/images/avatar/2.jpg')}}" alt="avatar" class="mr-3">
                                <div class="media-body">
                            ...
                            <div class="media border-bottom pt-3 pb-3">
                                <img src="{{asset('layouts_admin/assets/images/avatar/3.jpg')}}" alt="avatar" class="mr-3">
                                <div class="media-body">
                            ...
                            <div class="media border-bottom pt-3 pb-3">
                                <img src="{{asset('layouts_admin/assets/images/avatar/4.jpg')}}" alt="avatar" class="mr-3">
                                <div class="media-body">
                            ...
                            <div class="media border-bottom pt-3 pb-3">
                                <img src="{{asset('layouts_admin/assets/images/avatar/5.jpg')}}" alt="avatar" class="mr-3">
                                <div class="media-body">
                            ...
                            <div class="media border-bottom pt-3 pb-3">
                                <img src="{{asset('layouts_admin/assets/images/avatar/6.jpg')}}" alt="avatar" class="mr-3">
                                <div class="media-body">
                            ...
                            <div class="media pt-3 pb-3">
                                <img src="{{asset('layouts_admin/assets/images/avatar/7.jpg')}}" alt="avatar" class="mr-3">
                                <div class="media-body">
