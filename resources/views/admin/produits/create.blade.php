...
<div class="content-body container">
    <div class="contact-form form">
        <form action="{{route('admin_produits.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            @php
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <select name="sous_famille_id" id="sous_famille_id" class="form-control input-rounded">
                        ...
                        <option value="{{$sous_famille->id}}">{{$sous_famille->sous_famille}}</option>
                        @endforeach
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control input-rounded" name="designation" >
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control input-rounded" name="prix_ht" >
                </div>
                <div class="col-md-6">
                    <label for="tva">TVA</label>
                    <input type="text" class="form-control input-rounded" name="tva" >
                </div>
                <div class="col-md-6">
                    <label for="stock">Stock</label>
                    <input type="text" class="form-control input-rounded" name="stock" >
                </div>
                <div class="col-md-6">
                    <label for="prix_achat_ht">Prix Achat</label>
                    <input type="text" class="form-control input-rounded" name="prix_achat_ht" >
                </div>
